...
},{"buffer":10,"os":11}],8:[function(require,module,exports) {
var ip = require('ip');
...
},{"ip":9}],7:[function(require,module,exports) {
module.exports = require('./src/Matcher');

},{"./src/Matcher":8}],6:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = arrayToSentence;
/*!
...
function arrayToSentence(arr, options) {
	...
	for (var i = 0; i < 2; i++) {
		if (typeof options[OPTION_NAMES[i]] !== 'string') {
			throw new TypeError('Expected `' + OPTION_NAMES[i] + '` option to be a string, but got a non-string value ' + options[OPTION_NAMES[i]] + '.');
		}
	}
...
var _cidrMatcher = require('cidr-matcher');

var _cidrMatcher2 = _interopRequireDefault(_cidrMatcher);

var _arrayToSentence = require('array-to-sentence');

var _arrayToSentence2 = _interopRequireDefault(_arrayToSentence);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch('https://api.github.com/meta').then(function (response) {
    ...
    Object.keys(jsonData).forEach(function (name) {
      ...
      if (Array.isArray(jsonData[name])) {
        ipGroups[name] = new _cidrMatcher2.default(jsonData[name]);
      }
    });

    checkIp = function checkIp(ipAddress) {
      return Object.keys(ipGroups).filter(function (name) {
        return ipGroups[name].contains(ipAddress);
      });
    };
  });

  ipInput.addEventListener('change', function () {
    var matches = checkIp(ipInput.value);
    ...
    resultOutput.innerText = 'Yep! That\'s an address GitHub use for ' + (0, _arrayToSentence2.default)(matches) + '!';
  });
});
},{"cidr-matcher":7,"array-to-sentence":6}],15:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.be2910c6.map